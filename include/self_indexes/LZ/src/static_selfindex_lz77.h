/* static_selfindex_lz77.h
 * Copyright (C) 2009, Sebastian Kreft C., all rights reserved.
 *
 * static_selfindex_lz77 definition
 *
...
#ifndef __STATIC_SELFINDEX_LZ77_H__
#define __STATIC_SELFINDEX_LZ77_H__
...
class static_selfindex_lz77 : public static_selfindex {
    public:
        ...
        static static_selfindex_lz77* load(FILE * fp);
        static static_selfindex_lz77* build(char* filename, char* filenameidx, unsigned char binaryRev, unsigned char binarySst, unsigned char store_sst_ids);
    protected:
